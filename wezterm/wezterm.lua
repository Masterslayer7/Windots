...
local function get_os()
    if wezterm.target_triple:find("windows") then return "windows"
    elseif wezterm.target_triple:find("linux") then return "linux"
    end
    return "macos"
end
...
if host_os == "linux" then emoji_font = "Noto Color Emoji" end
